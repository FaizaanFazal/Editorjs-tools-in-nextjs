...
export default class CustomList {
  ...
  constructor({ data, config, api, readOnly }: any) {
    ...
    this.settings = [
      ...
      {
        name: 'unorderedNoBullet',
        label: this.api.i18n.t('Unordered No Bullet'),
        icon: IconListBulleted,
        default: config.defaultStyle === 'unorderedNoBullet' || false,
      },
      {
        name: 'ordered',
     ...
     */
    this._data = {
      style: this.settings.find((tune: any) => tune.default === true).name,
      items: [],
    };
   ...
   */
  renderSettings() {
    return this.settings.map((item: any) => ({
      ...item,
   ...
   */
  makeMainTag(style: any) {
    const styleClass = style === 'ordered' ? this.CSS.wrapperOrdered : style === 'unorderedNoBullet' ? this.CSS.wrapperWnorderedNoBullet : this.CSS.wrapperUnordered;
  ...
  get CSS() {
    return {
      ...
      wrapperWnorderedNoBullet: 'cdx-list--unorderedNoBullet',
      item: 'cdx-list__item',
    };
  }
  ...
  set data(listData) {
    ...
    this._data.style = listData.style || this.settings.find((tune: any) => tune.default === true).name;
  ...
  selectItem(event: any) {
    ...
    const selection = window.getSelection(),
      currentNode: any = selection?.anchorNode?.parentNode,
